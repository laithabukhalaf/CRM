...
class Client extends Component {
    ...
    updateClient=()=>{
        if(this.state.updateName==="" || this.state.updateSurname==="" || this.state.updateCountry===""){
            return ToastsStore.error("All fields must be filled")
        }
        else{
            this.props.updatePopInfo(this.state.updateName, this.state.updateSurname, this.state.updateCountry, this.props.client._id)   
